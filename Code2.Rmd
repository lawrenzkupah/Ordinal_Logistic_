...
stargazer(QDEP.2,AEFT.2,AHOPS.2,ARES.2,ASAD.2,AWORS.2,QINTR.2,apply.coef = exp,style = "qje",ord.intercepts = "TRUE")
...
stargazer(QDEP.3 ,QINTR.3,AEFT.3 ,AHOPS.3,ARES.3,ASAD.3,AWORS.3, keep = keep.1,apply.coef = exp,style = "qje",ord.intercepts = "TRUE")
```
